...
/**
 * Sets req.user when a valid Bearer token is present; otherwise allows anonymous (guest) access.
 * Invalid Bearer still fails (do not silently fall through to guest).
 */
@Injectable()
